...
export function LayerSettingsDialog({ open, onOpenChange, layer }: LayerSettingsDialogProps) {
    ...
    function displayToast(arg0: { title: string; description: string; }) {
        toast(arg0.title, {
    ...
    return (
        <>
            <div className="z-[100] absolute top-0 right-0 display-none">
                <Toaster />
            </div>
